    ...
    <div class="dashboard-container">
        ...
        <div class="main-sidebar">
            ...
            <div class="main-container">
                <h3 class="main-titre">Statistique de réservation des tables</h3>
                    <div class="insights">
                        <div class="card">
                                        ...
                                        <canvas id="barCanvas" aria-label="chart" role="img">
                                            ...
                                            <script>
                                                ...
                                                <?php
                                                    ...
                                                    $reserve = $con->prepare("SELECT COUNT(id_reservation_table) AS effectif, datee FROM reservation_table GROUP BY datee");
                                                    $reserve->execute();
                                                    $data = $reserve->fetchAll(PDO::FETCH_ASSOC);

                                                    $labels = array_column($data, 'datee');
                ...
                <div class="extrabar">
                    <header class="header-right">
                        ...
                        <div class="toggle-enveloppe">
                            <?php
                            include_once("connexion.php");
                            $select = $con->prepare("SELECT * FROM reservation_table WHERE status =0");
                            $select->execute();
                                    ...
                                    <?php
                                        ...
                                        if($count>0){
                                            foreach($count as $element){
                                                echo ' <a class="dropdown-item" href="reservation_table.php?id_reservation_table='.$element['id_reservation_table'].' ">'.$element['heure_table'].'</a> ';
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php
                                        $sr_no = 0; 
                                        include("connexion.php");
                                        $notify = $con->prepare("SELECT * FROM reservation_table WHERE status = 1");
                                        $notify->execute();
                                        // $tab = $notify->fetchAll();
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $element["datee"] ;?></td>
                                        <td><?php echo $element["heure_table"] ;?></td>
                                        <td><?php echo $element["id_client"] ;?></td>
                                        <td><?php echo $element["id_table"] ;?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
