...
<?php
    if(isset($_POST["ajout"])){
        ...
        $sql = $con->prepare("INSERT INTO reservationPiscine(imgPiscine1,imgPiscine2, imgPiscine3, paragraphesPiscine, paragraphesPiscine2) VALUES (?, ?, ?, ?, ?)");
            ...
            <div class="main-container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            include_once("../connexion.php");
                            $sql = $con->prepare("SELECT * FROM reservationPiscine");
                            $sql->execute();
                            $fetch = $sql->fetchAll();
                            foreach($fetch as $tab){
                        ?>
                            <tr>
                                <td><img src="../image/<?php echo $tab["imgPiscine1"];?>" width="50px" height="50px"></td>
                                <td><img src="../image/<?php echo $tab["imgPiscine2"];?>" width="50px" height="50px"></td>
                                <td><img src="../image/<?php echo $tab["imgPiscine3"];?>" width="50px" height="50px"></td>
                                <td><?php echo $tab["paragraphesPiscine"]; ?></td>
                                <td><?php echo $tab["paragraphesPiscine2"]; ?></td>
                                <td><a href="modif_reservationPiscine.php?idPiscine=<?php echo $tab["idPiscine"]; ?>"><i class="fa fa-pen"></i></a></td>
                                <td><a href="sup_reservationPiscine.php?idPiscine=<?php echo $tab["idPiscine"]; ?>"><i class="fa fa-window-close"></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
