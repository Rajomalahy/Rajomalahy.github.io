...
// }
    $id = $_GET["idSalle"];
    $select = $con->prepare("SELECT * FROM reservationSalle WHERE idSalle = :idSalle");
...
if (isset($_POST["ajout"])) {
    ...
    for ($i = 1; $i <= 3; $i++) {
        if (!empty($_FILES["my_image$i"]["tmp_name"])){
            ...
            $images[] = $data[0]["imgSalle$i"];
            $modif = $con->prepare("UPDATE reservationSalle SET paragraphesSalle = :paragraphes, paragraphesSalle2 = :paragraphes2 WHERE idSalle = $id");
            $modif->execute(array(
                'paragraphes' => $para,
                'paragraphes2' => $para2
            ));
    ...
    $modif = $con->prepare("UPDATE reservationSalle SET imgSalle1 = ?, imgSalle2 = ?, imgSalle3 = ?, paragraphesSalle = ?, paragraphesSalle2 = ? WHERE idSalle = ?");
                ...
                <div class="panel-body">
                    <form method="post" enctype ="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?php if (!empty($data[0]["imgSalle$i"])): ?>
                                    <img src="../image/<?php echo $data[0]["imgSalle$i"]; ?>" alt="Image actuelle" width="100">
                                <?php else: ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" name="paragraphes" id="paragraphes" class="form-control" value ="<?php echo $data[0]["paragraphesSalle"]; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabel" class="col-sm-2 col-form-label">paragraphe</label>
                                <div class="col-sm-10">
                                <input type="text" name="paragraphes2" id="paragraphes" class="form-control" value= "<?php echo $data[0]["paragraphesSalle"]; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-10">
