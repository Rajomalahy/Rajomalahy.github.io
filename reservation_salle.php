...
session_start();
    ...
    if(isset($_GET["id_reservation_salle"])){
        $main_id = $_GET["id_reservation_salle"];
        $modif_notif = $con->prepare("UPDATE reservation_salle SET status = 1 WHERE id_reservation_salle = '$main_id'");
        $modif_notif->execute();
    }
?>
<?php
    ...
    <div class="dashboard-container">
        <div class="main-sidebar">
            ...
            <div class="main-container">
                <h3 class="main-titre">Statistique de réservation de salle</h3>
                    <div class="insights">
                        <div class="card">
                ...
                <div class="statistique">
                    <div class="card-visite1">
                        <div class="state2">
                            <h4> Statistiques des réservations de salle</h4>
                            <div class="state-1">
                                ...
                                include("connexion.php");
                                $reserve = $con->prepare("SELECT COUNT(id_reservation_salle) AS effectif, date_salle FROM reservation_salle GROUP BY date_salle");
                                $reserve->execute();
                                $data = $reserve->fetchAll(PDO::FETCH_ASSOC);

                                $labels = array_column($data, 'date_salle');
                ...
                <div class="extrabar">
                    <header class="header-right">
                        ...
                        <div class="toggle-enveloppe">
                            <?php
                            include_once("connexion.php");
                            $select = $con->prepare("SELECT * FROM reservation_salle WHERE status =0");
                            $select->execute();
                                    ...
                                    <?php
                                        ...
                                        if($count>0){
                                            foreach($count as $element){
                                                echo ' <a class="dropdown-item" href="reservation_salle.php?id_reservation_salle='.$element['id_reservation_salle'].' ">'.$element['date_salle'].'</a> ';
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php
                                        $sr_no = 0; 
                                        include("connexion.php");
                                        $notify = $con->prepare("SELECT * FROM reservation_salle WHERE status = 1");
                                        $notify->execute();
                                        // $tab = $notify->fetchAll();
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $element["date_salle"] ;?></td>
                                        <td><?php echo $element["heure_debut_salle"] ;?></td>
                                        <td><?php echo $element["heure_fin_salle"] ;?></td>
                                        <td><?php echo $element["id_client"] ;?></td>
                                        <td><?php echo $element["id_salle"] ;?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
