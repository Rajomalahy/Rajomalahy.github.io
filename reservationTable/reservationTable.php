...
<?php
    if(isset($_POST["ajout"])){
        ...
        $sql = $con->prepare("INSERT INTO reservationtable(imgTable1,imgTable2, imgTable3, paragraphesTable, paragraphesTable2) VALUES (?, ?, ?, ?, ?)");
            ...
            <div class="main-container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            include_once("../connexion.php");
                            $sql = $con->prepare("SELECT * FROM reservationtable");
                            $sql->execute();
                            $fetch = $sql->fetchAll();
                            foreach($fetch as $tab){
                        ?>
                            <tr>
                                <td><img src="../image/<?php echo $tab["imgTable1"];?>" width="50px" height="50px"></td>
                                <td><img src="../image/<?php echo $tab["imgTable2"];?>" width="50px" height="50px"></td>
                                <td><img src="../image/<?php echo $tab["imgTable3"];?>" width="50px" height="50px"></td>
                                <td><?php echo $tab["paragraphesTable"]; ?></td>
                                <td><?php echo $tab["paragraphesTable2"]; ?></td>
                                <td><a href="modif_reservationTable.php?idTable=<?php echo $tab["idTable"]; ?>"><i class="fa fa-pen"></i></a></td>
                                <td><a href="sup_reservationTable.php?idTable=<?php echo $tab["idTable"]; ?>"><i class="fa fa-window-close"></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
