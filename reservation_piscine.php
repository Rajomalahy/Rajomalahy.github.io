...
session_start();
    ...
    if(isset($_GET["id_reservation_piscine"])){
        $main_id = $_GET["id_reservation_piscine"];
        $modif_notif = $con->prepare("UPDATE reservation_piscine SET status = 1 WHERE id_reservation_piscine = '$main_id'");
        $modif_notif->execute();
    }
?>
<?php
...
<head>
    ...
    <title>reservation piscine</title>
</head>
<body>
    <div class="dashboard-container">
        <div class="main-sidebar">
            ...
            <div class="main-container">
                <h3 class="main-titre">Statistique de réservation de piscine</h3>
                    <div class="insights">
                        <div class="card">
                ...
                <div class="statistique">
                    <div class="card-visite1">
                        <div class="state2">
                            <h4> Statistiques des réservations de piscine</h4>
                            <div class="state-1">
                                ...
                                <?php
                                    ...
                                    include("connexion.php");
                                    $reserve = $con->prepare("SELECT COUNT(id_reservation_piscine) AS effectif, date_piscine FROM reservation_piscine GROUP BY date_piscine");
                                    $reserve->execute();
                                    $data = $reserve->fetchAll(PDO::FETCH_ASSOC);

                                    $labels = array_column($data, 'date_piscine');
                ...
                <div class="extrabar">
                    <header class="header-right">
                        ...
                        <div class="toggle-enveloppe">
                            <?php
                            include_once("connexion.php");
                            $select = $con->prepare("SELECT * FROM reservation_piscine WHERE status =0");
                            $select->execute();
                                    ...
                                    <?php
                                        ...
                                        if($count>0){
                                            foreach($count as $element){
                                                echo ' <a class="dropdown-item" href="reservation_piscine.php?id_reservation_piscine='.$element['id_reservation_piscine'].' ">'.$element['date_piscine'].'</a> ';
                            ...
                            <table>
                                <thead class="minuscule">
                                    <tr>
                                        ...
                                        <th scope="col">heureD</th>
                                        <th scope="col">heureF</th>
                                ...
                                <tbody>
                                    <?php
                                        $sr_no = 0; 
                                        include("connexion.php");
                                        $notify = $con->prepare("SELECT * FROM reservation_piscine WHERE status = 1");
                                        $notify->execute();
                                        // $tab = $notify->fetchAll();
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $element["date_piscine"] ;?></td>
                                        <td><?php echo $element["heure_debut_piscine"] ;?></td>
                                        <td><?php echo $element["heure_fin_piscine"] ;?></td>
                                        <td><?php echo $element["id_client"] ;?></td>
                                        <td><?php echo $element["id_piscine"] ;?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
